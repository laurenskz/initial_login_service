...
class FoodSource(_message.Message):
    __slots__ = ("id", "localizations", "handle")
    ID_FIELD_NUMBER: _ClassVar[int]
    LOCALIZATIONS_FIELD_NUMBER: _ClassVar[int]
    HANDLE_FIELD_NUMBER: _ClassVar[int]
    id: str
    localizations: _containers.RepeatedCompositeFieldContainer[FoodSourceLocalized]
    handle: str
    def __init__(self, id: _Optional[str] = ..., localizations: _Optional[_Iterable[_Union[FoodSourceLocalized, _Mapping]]] = ..., handle: _Optional[str] = ...) -> None: ...

class FoodSourceLocalized(_message.Message):
...
class FoodSourceRef(_message.Message):
    __slots__ = ("id", "name")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    id: str
