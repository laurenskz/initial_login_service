...
class MealPlanDay(_message.Message):
    __slots__ = ("id", "meals", "owner", "name", "description", "appliedPlugins", "defaultDayVariables")
    ID_FIELD_NUMBER: _ClassVar[int]
    MEALS_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    APPLIEDPLUGINS_FIELD_NUMBER: _ClassVar[int]
    DEFAULTDAYVARIABLES_FIELD_NUMBER: _ClassVar[int]
    id: str
    meals: _containers.RepeatedCompositeFieldContainer[_meal_pb2.MealRef]
    owner: _users_pb2.UserRef
    name: str
    description: str
    appliedPlugins: _containers.RepeatedCompositeFieldContainer[_plugins_pb2.PluginRef]
    defaultDayVariables: _containers.RepeatedCompositeFieldContainer[_plugins_pb2.InstantiatedPluginVariable]
    def __init__(self, id: _Optional[str] = ..., meals: _Optional[_Iterable[_Union[_meal_pb2.MealRef, _Mapping]]] = ..., owner: _Optional[_Union[_users_pb2.UserRef, _Mapping]] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., appliedPlugins: _Optional[_Iterable[_Union[_plugins_pb2.PluginRef, _Mapping]]] = ..., defaultDayVariables: _Optional[_Iterable[_Union[_plugins_pb2.InstantiatedPluginVariable, _Mapping]]] = ...) -> None: ...
