...
class PluginVariableList(_message.Message):
    __slots__ = ("items", "nextPageToken")
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    NEXTPAGETOKEN_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[_plugins_pb2.PluginVariableRef]
    nextPageToken: str
    def __init__(self, items: _Optional[_Iterable[_Union[_plugins_pb2.PluginVariableRef, _Mapping]]] = ..., nextPageToken: _Optional[str] = ...) -> None: ...

class PluginVariableUpdateRequest(_message.Message):
    __slots__ = ("id", "newValue")
    ID_FIELD_NUMBER: _ClassVar[int]
    NEWVALUE_FIELD_NUMBER: _ClassVar[int]
    id: str
    newValue: _plugins_pb2.PluginVariable
    def __init__(self, id: _Optional[str] = ..., newValue: _Optional[_Union[_plugins_pb2.PluginVariable, _Mapping]] = ...) -> None: ...

class PluginVariableQuery(_message.Message):
