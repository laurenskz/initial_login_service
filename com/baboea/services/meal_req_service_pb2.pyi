...
class MealPlanGenerateSet(_message.Message):
    __slots__ = ("foods", "concepts", "implementationNodes", "conversions", "gramsUnit", "properties", "kcalProp", "foodWeightProp", "foodCountProp", "recipeCountProp", "mealPlanApplication", "dayApplication", "mealApplication", "mealComponentApplication", "mealComponents", "recipes", "sides", "foodRefs")
