...
from com.baboea.services import built_recipe_service_pb2 as com_dot_baboea_dot_services_dot_built__recipe__service__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in com/baboea/services/built_recipe_service_pb2_grpc.py depends on'
...
class ParsedRemoteRecipeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                '/com.baboea.services.ParsedRemoteRecipeService/Add',
        ...
        self.Remove = channel.unary_unary(
                '/com.baboea.services.ParsedRemoteRecipeService/Remove',
                request_serializer=com_dot_baboea_dot_models_dot_recipes__pb2.ParsedRemoteRecipe.SerializeToString,
                response_deserializer=com_dot_baboea_dot_services_dot_base__pb2.RemoveResponse.FromString,
                _registered_method=True)
        self.GetAll = channel.unary_unary(
                '/com.baboea.services.ParsedRemoteRecipeService/GetAll',
                request_serializer=com_dot_baboea_dot_services_dot_base__pb2.GetAllRequest.SerializeToString,
                response_deserializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeList.FromString,
                _registered_method=True)
        self.Search = channel.unary_unary(
                '/com.baboea.services.ParsedRemoteRecipeService/Search',
                request_serializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeQuery.SerializeToString,
                response_deserializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeList.FromString,
                _registered_method=True)
        self.Get = channel.unary_unary(
                '/com.baboea.services.ParsedRemoteRecipeService/Get',
                request_serializer=com_dot_baboea_dot_services_dot_base__pb2.GetRequest.SerializeToString,
                response_deserializer=com_dot_baboea_dot_models_dot_recipes__pb2.ParsedRemoteRecipe.FromString,
                _registered_method=True)
        self.Update = channel.unary_unary(
                '/com.baboea.services.ParsedRemoteRecipeService/Update',
                request_serializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeUpdateRequest.SerializeToString,
                response_deserializer=com_dot_baboea_dot_services_dot_base__pb2.UpdateResponse.FromString,
                _registered_method=True)
        self.ResolveByIds = channel.unary_unary(
...
class ParsedRemoteRecipeServiceServicer(object):
    ...
    def ResolveByIds(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ParsedRemoteRecipeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAll': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeList.SerializeToString,
            ),
            'Search': grpc.unary_unary_rpc_method_handler(
                    servicer.Search,
                    request_deserializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeQuery.FromString,
                    response_serializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeList.SerializeToString,
            ),
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=com_dot_baboea_dot_services_dot_base__pb2.GetRequest.FromString,
                    response_serializer=com_dot_baboea_dot_models_dot_recipes__pb2.ParsedRemoteRecipe.SerializeToString,
            ),
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeUpdateRequest.FromString,
                    response_serializer=com_dot_baboea_dot_services_dot_base__pb2.UpdateResponse.SerializeToString,
            ),
            'ResolveByIds': grpc.unary_unary_rpc_method_handler(
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.baboea.services.ParsedRemoteRecipeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.baboea.services.ParsedRemoteRecipeService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class ParsedRemoteRecipeService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GetAll(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Search(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.baboea.services.ParsedRemoteRecipeService/Search',
            com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeQuery.SerializeToString,
            com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeList.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            com_dot_baboea_dot_models_dot_recipes__pb2.ParsedRemoteRecipe.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Update(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.baboea.services.ParsedRemoteRecipeService/Update',
            com_dot_baboea_dot_services_dot_built__recipe__service__pb2.ParsedRemoteRecipeUpdateRequest.SerializeToString,
