...
class FoodUnitList(_message.Message):
    __slots__ = ("items", "nextPageToken")
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    NEXTPAGETOKEN_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[_food_units_pb2.FoodUnitRef]
    nextPageToken: str
    def __init__(self, items: _Optional[_Iterable[_Union[_food_units_pb2.FoodUnitRef, _Mapping]]] = ..., nextPageToken: _Optional[str] = ...) -> None: ...

class FoodUnitUpdateRequest(_message.Message):
    __slots__ = ("id", "newValue")
    ID_FIELD_NUMBER: _ClassVar[int]
    NEWVALUE_FIELD_NUMBER: _ClassVar[int]
    id: str
    newValue: _food_units_pb2.FoodUnit
    def __init__(self, id: _Optional[str] = ..., newValue: _Optional[_Union[_food_units_pb2.FoodUnit, _Mapping]] = ...) -> None: ...

class FoodUnitQuery(_message.Message):
