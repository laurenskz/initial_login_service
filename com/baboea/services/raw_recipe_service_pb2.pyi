...
class RemoteRecipeList(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_recipes_pb2.RemoteRecipeRef]
    nextPageToken: str
    def __init__(self, items: _Optional[_Iterable[_Union[_recipes_pb2.RemoteRecipeRef, _Mapping]]] = ..., nextPageToken: _Optional[str] = ...) -> None: ...

class RemoteRecipeUpdateRequest(_message.Message):
    __slots__ = ("id", "newValue")
    ID_FIELD_NUMBER: _ClassVar[int]
    NEWVALUE_FIELD_NUMBER: _ClassVar[int]
    id: str
    newValue: _recipes_pb2.RemoteRecipe
    def __init__(self, id: _Optional[str] = ..., newValue: _Optional[_Union[_recipes_pb2.RemoteRecipe, _Mapping]] = ...) -> None: ...

class RemoteRecipeQuery(_message.Message):
