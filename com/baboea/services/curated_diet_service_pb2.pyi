...
class CuratedDietList(_message.Message):
    __slots__ = ("items", "nextPageToken")
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    NEXTPAGETOKEN_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[_curated_diet_pb2.CuratedDietRef]
    nextPageToken: str
    def __init__(self, items: _Optional[_Iterable[_Union[_curated_diet_pb2.CuratedDietRef, _Mapping]]] = ..., nextPageToken: _Optional[str] = ...) -> None: ...

class CuratedDietUpdateRequest(_message.Message):
    __slots__ = ("id", "newValue")
    ID_FIELD_NUMBER: _ClassVar[int]
    NEWVALUE_FIELD_NUMBER: _ClassVar[int]
    id: str
    newValue: _curated_diet_pb2.CuratedDiet
    def __init__(self, id: _Optional[str] = ..., newValue: _Optional[_Union[_curated_diet_pb2.CuratedDiet, _Mapping]] = ...) -> None: ...

class CuratedDietQuery(_message.Message):
