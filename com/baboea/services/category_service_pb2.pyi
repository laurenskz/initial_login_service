...
class RecipeCategoryList(_message.Message):
...
class RecipeCategoryUpdateRequest(_message.Message):
    __slots__ = ("id", "newValue")
    ID_FIELD_NUMBER: _ClassVar[int]
    NEWVALUE_FIELD_NUMBER: _ClassVar[int]
    id: str
    newValue: _recipes_pb2.RecipeCategory
    def __init__(self, id: _Optional[str] = ..., newValue: _Optional[_Union[_recipes_pb2.RecipeCategory, _Mapping]] = ...) -> None: ...

class RecipeCategoryQuery(_message.Message):
