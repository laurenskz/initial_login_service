...
class PluginList(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_plugins_pb2.PluginRef]
    nextPageToken: str
    def __init__(self, items: _Optional[_Iterable[_Union[_plugins_pb2.PluginRef, _Mapping]]] = ..., nextPageToken: _Optional[str] = ...) -> None: ...

class PluginUpdateRequest(_message.Message):
    __slots__ = ("id", "newValue")
    ID_FIELD_NUMBER: _ClassVar[int]
    NEWVALUE_FIELD_NUMBER: _ClassVar[int]
    id: str
    newValue: _plugins_pb2.Plugin
    def __init__(self, id: _Optional[str] = ..., newValue: _Optional[_Union[_plugins_pb2.Plugin, _Mapping]] = ...) -> None: ...

class PluginQuery(_message.Message):
